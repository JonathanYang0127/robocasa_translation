...
def extract_trajectory(
    ...
    for t in range(traj_len):
        ...
        if add_aux_info:
            ...
            normalized_eef_2d = eef_2d / env.env.camera_widths[0]  # Normalize between [0,1]
            ...
            bbox_2d = bbox_2d / env.env.camera_widths[0]
    ...
    if output_name is None:
        if len(args.camera_names) == 0:
            ...
            if args.generative_textures:
                ...
                output_name = os.path.basename(args.dataset)[:-5] + "_im{}_libero.hdf5".format(
                    image_suffix
                )
